...
'''
produce the smpl instance of smpl
v_template : base smpl model vertice
pose : smpl pose
...
def verts_decorated(trans, pose, 
    ...
    if shapedirs is not None:
        ...
        v_shaped = v
    # produce the smpl pose model. pose is rotation vector and transfrom to the ratation matrix     
